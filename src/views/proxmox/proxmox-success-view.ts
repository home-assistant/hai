...
export class ProxmoxSuccessView extends LitElement {
  ...
  render() {
    ...
    return html`
      ...
      <p class="subtitle">
        Home Assistant is now running on Proxmox as "${vmName}" (VM ${vmId}) on
        node "${node}"
      </p>
      ...
      <div class="tip-section">
        ...
        anytime from the Proxmox web interface. The VM is configured to start
        automatically when Proxmox boots.
      </div>
